...
//     targetWeight: number;
//     height: number;
//     activityLevel: string; // Добавляем уровень активности
// }
...
//     fat: number;
//     carbs: number;
//     activityMultiplier: number; // Добавляем коэффициент активности в результат
// }
...
//         targetWeight: 0,
//         height: 0,
//         activityLevel: 'moderate' // значение по умолчанию
//     });
...
//         "Нет теплей влагалища, чем очко товарища",
//         "Нет боли - нет роста. Но если больно слишком - может, стоит к врачу?",
//         "Пропустил одну тренировку, потом вторую... а там уже и диван стал лучшим другом!"
//     ];
...
//         // Умная проверка на разницу в весе
...
//             // Дополнительные проверки для реалистичных целей
...
//         // Коэффициент активности из выбора пользователя
...
//             targetCalories = maintenanceCalories * 1.15; // +15% для набора
//         } else {
//             targetCalories = maintenanceCalories * 0.85; // -15% для похудения
//         }
...
//     // Описания уровней активности для отображения
...
//                 {/* Добавляем выбор уровня активности */}
//                 <select
//                     name="activityLevel"
...
//                         <p>Самое главное не пизди тренеру что не пропускаешь треню, а востальном:</p>
...
function Nutrition() {
    ...
    const quotes = [
        "Сначала ты решил пропустить тренировку, а потом попьешь раф на хуесосовом молоке...",
        "Завтра начну... а пока можно и пончик!",
        "Почему когда программист вставил палец в жопу, то сказал нормально??? Потому что до этого там был костыль...",
        "Нет боли - нет роста. Но если больно слишком - может, стоит вынуть анальную пробку?",
        "Пропустил одну тренировку, потом вторую... а там уже и гей клуб сходи!"
    ];
